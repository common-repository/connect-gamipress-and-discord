...
<form method="post" action="<?php echo esc_url( get_site_url() ) . '/wp-admin/admin-post.php'; ?>">
  ...
  <div class="ets-input-group">
	<?php $ets_gamipress_discord_client_id_value = isset( $ets_gamipress_discord_client_id ) ? $ets_gamipress_discord_client_id : ''; ?>
	<label><?php esc_html_e( 'Client ID', 'connect-gamipress-discord-addon' ); ?> :</label>
	<input type="text" class="ets-input" name="ets_gamipress_discord_client_id" value="<?php echo esc_attr( $ets_gamipress_discord_client_id_value ); ?>" required placeholder="Discord Client ID">
  </div>
	<div class="ets-input-group">
		<?php $ets_gamipress_discord_client_secret_value = isset( $ets_gamipress_discord_client_secret ) ? $ets_gamipress_discord_client_secret : ''; ?>
	  <label><?php esc_html_e( 'Client Secret', 'connect-gamipress-discord-addon' ); ?> :</label>
		<input type="text" class="ets-input" name="ets_gamipress_discord_client_secret" value="<?php echo esc_attr( $ets_gamipress_discord_client_secret_value ); ?>" required placeholder="Discord Client Secret">
	</div>
	<div class="ets-input-group">
	...
	<div class="ets-input-group">
			...
			if ( isset( $ets_gamipress_discord_connected_bot_name ) && ! empty( $ets_gamipress_discord_connected_bot_name ) ) {
				_e(
					sprintf(
						wp_kses(
							__( '<p class="description">Make sure the Bot %1$s <span class="discord-bot"><b>BOT</b></span>have the high priority than the roles it has to manage. Open <a href="https://discord.com/channels/%2$s">Discord Server</a></p>', 'connect-gamipress-discord-addon' ),
							array(
								'p'    => array( 'class' => array() ),
								'a'    => array( 'href' => array() ),
			...
			?>
			<?php $ets_gamipress_discord_bot_token_value = isset( $ets_gamipress_discord_bot_token ) ? $ets_gamipress_discord_bot_token : ''; ?>
	  <label><?php esc_html_e( 'Bot Token', 'connect-gamipress-discord-addon' ); ?> :</label>
		  <input type="password" class="ets-input" name="ets_gamipress_discord_bot_token" value="<?php echo esc_attr( $ets_gamipress_discord_bot_token_value ); ?>" required placeholder="Discord Bot Token">
	</div>
	<div class="ets-input-group">
		<?php $ets_gamipress_discord_server_id_value = isset( $ets_gamipress_discord_server_id ) ? $ets_gamipress_discord_server_id : ''; ?>
	  <label><?php esc_html_e( 'Server ID', 'connect-gamipress-discord-addon' ); ?> :</label>
		...
		placeholder="Discord Server Id" value="<?php echo esc_attr( $ets_gamipress_discord_server_id_value ); ?>" required>
	</div>
